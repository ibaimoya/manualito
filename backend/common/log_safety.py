...
def safe_for_log(value: str | None, *, fallback: str = "<unknown>") -> str:
    ...
    Sustituye por ``?`` cada carácter del rango ``0x00-0x1f`` y ``0x7f`` (incluye
    CR, LF, TAB y otros caracteres de control). Mantiene letras, dígitos,
    acentos, espacios y signos de puntuación normales.
