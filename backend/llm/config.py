...
OLLAMA_STARTUP_CHECK_TIMEOUT = _float_env(
    "OLLAMA_STARTUP_CHECK_TIMEOUT",
    default=10.0,
    minimum=1.0,
)
OLLAMA_PRELOAD_TIMEOUT = _float_env("OLLAMA_PRELOAD_TIMEOUT", default=180.0, minimum=1.0)
OLLAMA_TEMPERATURE = _float_env("OLLAMA_TEMPERATURE", default=0.2, minimum=0.0)
